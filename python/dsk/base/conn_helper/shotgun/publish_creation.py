...
from dsk.base.conn_helper.shotgun.publish_util import get_published_file_entity_type, get_cached_local_storages, find_publish
from dsk.base.conn_helper.shotgun.shotgundsk_errors import ShotgunPublishError
from dsk.base.resources.dsk_errors import DskError, DskMultipleMatchingTemplatesError
...
def _translate_abstract_fields(tk, path):
    ...
    except DskMultipleMatchingTemplatesError:
        log.debug(
