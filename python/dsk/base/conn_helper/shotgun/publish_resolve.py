...
from dsk.base.conn_helper.shotgun.publish_util import get_cached_local_storages
from dsk.base.path_helper.shotgun_path import ShotgunPath


from dsk.base.conn_helper.shotgun.shotgundsk_errors import PublishPathNotDefinedError
from dsk.base.conn_helper.shotgun.shotgundsk_errors import PublishPathNotSupported
...
def __resolve_url_link(tk, attachment_data):
    ...
    parsed_url = urlparse(attachment_data["url"])
    ...
    #
    # >>> urlparse("file:///path/to/some/file.txt")
    ...
    #
    # >>> urlparse("file://laptop/My%20Documents/FileSchemeURIs.doc")
    ...
    #
    # >>> urlparse("file:///C:/Documents%20and%20Settings/davris/FileSchemeURIs.doc")
    ...
    if parsed_url.netloc:
        # unc path
        resolved_path = unquote("//%s%s" % (parsed_url.netloc, parsed_url.path))
    else:
        resolved_path = unquote(parsed_url.path)
