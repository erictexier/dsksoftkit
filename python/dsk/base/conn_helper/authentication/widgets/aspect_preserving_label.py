...
class AspectPreservingLabel(QtT.QtWidgets.QLabel):
    """
    ...
    def __init__(self, parent=None):
        ...
        """
        super(AspectPreservingLabel,self).__init__(parent)
        self._pix = None
    ...
    def setPixmap(self, pixmap):
        ...
        """
        self._pix = pixmap
        scaled_pixmap = self._pix.scaled(self.size(), 
                                         QtT.QtCore.Qt.KeepAspectRatio, 
                                         QtT.QtCore.Qt.SmoothTransformation)
        QtT.QtWidgets.QLabel.setPixmap(self, scaled_pixmap)
    ...
    def heightForWidth(self, width):
        ...
        return QtT.QtWidgets.QLabel.heightForWidth(self, width)
    ...
    def sizeHint(self):
        ...
        return QtT.QtCore.QSize(width, self.heightForWidth(width))

    def resizeEvent(self, er):
        """
        Rescales the pixmap when the widget size is changed.

        :param er: Resize event payload.
        """
