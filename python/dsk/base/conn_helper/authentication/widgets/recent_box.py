...
from dsk.base.conn_helper.authentication.widgets.completion_filter_proxy import CompletionFilterProxy


class RecentBox(QtT.QtWidgets.QComboBox):
    """
    ...
    def __init__(self, parent):
        ...
        self._recent_items_model = QtT.QtCore.QStringListModel(self)
        self._drop_down_model = QtT.QtCore.QSortFilterProxyModel(self)
        ...
        self._completer = QtT.QtWidgets.QCompleter(self)
        self._completer.setCompletionMode(QtT.QtWidgets.QCompleter.UnfilteredPopupCompletion)
