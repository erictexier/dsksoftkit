...
from dsk.base.conn_helper.authentication.errors import AuthenticationCancelled, ShotgunAuthenticationError
from dsk.base.conn_helper.authentication import invoker
...
try:
    from dsk.base.conn_helper.authentication.widgets.login_auth_dialog import LoginAuthDialog as LoginDialog
    #from dsk.base.conn_helper.authentication.login_dialog import LoginDialog
except Exception:
    LoginDialog = None
...
class UiAuthenticationHandler(object):
    ...
    def authenticate(self, hostname, login, http_proxy, session):
        """
        ...
        def _process_ui():
            dlg = LoginDialog(is_session_renewal=self._is_session_renewal,
                              hostname=hostname,
                              login=login,
