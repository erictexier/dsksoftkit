...
class DefaultsManager(object):
    ...
    def __init__(self, fixed_host=None):
        ...
        self._cache_session = SessionData(self._user_settings.get_location())
    ...
    def recent_hosts(self):
        return self._cache_session.get_recent_hosts()
    ...
    def get_host(self):
        ...
        applications (at the moment, sgtk and Shotgun Desktop).
        ...
        """
        return (self._fixed_host or 
                self._cache_session.get_current_host() or 
                self._user_settings.default_site)
    ...
    def set_host(self, host):
        ...
        if self.is_host_fixed():
            return
        self._cache_session.set_current_host(host)
    ...
    def get_login(self):
        ...
        if self.get_host():
            return self._cache_session.get_current_user(self.get_host()) or self._user_settings.default_login
        else:
    ...
    def get_user_credentials(self):
        ...
        if self.get_host() and self.get_login():
            return self._cache_session.get_session_data(self.get_host(),
                                                        self.get_login())
        else:
            return None
    ...
    def set_login(self, login):
        ...
        self._login = login
        self._cache_session.set_current_user(self.get_host(), login)
