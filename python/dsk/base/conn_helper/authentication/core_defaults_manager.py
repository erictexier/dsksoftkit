...
from dsk.base.conn_helper.shotgun.connection import get_associated_sg_config_data
...
class CoreDefaultsManager(DefaultsManager):
    ...
    def get_http_proxy(self):
        ...
        """
        sg_config_data = get_associated_sg_config_data()
    ...
    def get_user_credentials(self):
        ...
        if not self._mask_script_user:
            data = get_associated_sg_config_data()
