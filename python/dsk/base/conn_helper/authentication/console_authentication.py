...
from dsk.base.conn_helper.authentication.errors import AuthenticationCancelled
from dsk.base.conn_helper.authentication.errors import ConsoleLoginNotSupportedError
...
from dsk.base.conn_helper.shotgun.connection import sanitize_url
...
class ConsoleAuthenticationHandlerBase(object):
    ...
    def authenticate(self, hostname, login, http_proxy,asession):
        """
        ...
        while True:
            ...
            try:
                try:
                    ...
                    return hostname, login, SessionData.generate_session_token(
