...
def create():
    ...
    if QtT.QtCore.QThread.currentThread() == QtT.QtWidgets.QApplication.instance().thread():
        return lambda fn, *args, **kwargs: fn(*args, **kwargs)

    class MainThreadInvoker(QtT.QtCore.QObject):
        """
        ...
        def __init__(self):
            ...
            self.moveToThread(QtT.QtWidgets.QApplication.instance().thread())
        ...
        def __call__(self, fn, *args, **kwargs):
            ...
            QtT.QtCore.QMetaObject.invokeMethod(self,
                                                "_do_invoke", 
                                                QtT.QtCore.Qt.BlockingQueuedConnection)
