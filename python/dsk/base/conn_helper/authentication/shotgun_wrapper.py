...
from shotgun_api3.lib.xmlrpclib import ProtocolError
from dsk.base.conn_helper.authentication import interactive_authentication, session_cache
...
class ShotgunWrapper(Shotgun):
    ...
    def _call_rpc(self, *args, **kwargs):
        ...
        try:
            ...
            # the session.
            if (e.errcode == httplib.FOUND and
        ...
        session_info = session_cache.SessionData.get_session_data(self._user.get_host(),
                                                                  self._user.get_login())
