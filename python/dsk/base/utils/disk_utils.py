...
class DiskUtils:
    ...
    def create_path_rec(fullPath):
        ...
        if an extension exist will not considered the last field as a
        dir but as a filename
        """
    ...
    def sort_files(listOfFile, mostRecentFirst=True):
        """ list of for file on disk, if file or directory do not exist
    ...
    def clip_time_files(listOfFile, atime):
        """ list of for file on disk, if file or directory do not exist they
        will be dropped
        """
